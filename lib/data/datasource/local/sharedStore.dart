...
class SharedStore{
  ...
  static Box _getBox(){
    return Hive.box(SHARED_STORE);
  }

  static void setUserToken(String value) => _getBox().put(USER_TOKEN, value);
  static String getUserToken() => _getBox().get(USER_TOKEN, defaultValue: "");
